...
directory = './finalWebsite/appartement/RandomForestRegressor/models'
...
parts_prefix = 'Auvergne-Rhône-Alpes.joblib.part'
output_file_path = './finalWebsite/appartement/RandomForestRegressor/models/Auvergne-Rhône-Alpes.joblib'
...
output_file_path = './finalWebsite/appartement/RandomForestRegressor/models/Nouvelle-Aquitaine.joblib'
join_files(parts_prefix, output_file_path, parts_dir)
# # Vérifie la taille finale du fichier recomposé
# print(f"Taille finale du fichier recomposé: {os.path.getsize(output_file_path)} octets")

parts_prefix = 'Occitanie.joblib.part'
output_file_path = './finalWebsite/appartement/RandomForestRegressor/models/Occitanie.joblib'
join_files(parts_prefix, output_file_path, parts_dir)
# # Vérifie la taille finale du fichier recomposé
# print(f"Taille finale du fichier recomposé: {os.path.getsize(output_file_path)} octets")